...
if [[ "$OSTYPE" == "darwin"* && -x "$(command -v mogrify)" ]]; then
  ...
  mogrify -resize 1200x -unsharp 0.5x0.5+0.5+0.008 $SCRIPT_PATH/photos/**/*.min.jpeg &>/dev/null
  mogrify -resize 1200x -unsharp 0.5x0.5+0.5+0.008 $SCRIPT_PATH/photos/**/*.min.png &>/dev/null
  mogrify -resize 1200x -unsharp 0.5x0.5+0.5+0.008 $SCRIPT_PATH/photos/**/*.min.jpg &>/dev/null
  mogrify -resize 1200x -unsharp 0.5x0.5+0.5+0.008 $SCRIPT_PATH/photos/**/*.min.JPEG &>/dev/null
  mogrify -resize 1200x -unsharp 0.5x0.5+0.5+0.008 $SCRIPT_PATH/photos/**/*.min.PNG &>/dev/null
  mogrify -resize 1200x -unsharp 0.5x0.5+0.5+0.008 $SCRIPT_PATH/photos/**/*.min.JPG &>/dev/null
  ...
  mogrify -resize 32x -unsharp 0.5x0.5+0.5+0.008 $SCRIPT_PATH/photos/**/*.placeholder.jpeg &>/dev/null
  mogrify -resize 32x -unsharp 0.5x0.5+0.5+0.008 $SCRIPT_PATH/photos/**/*.placeholder.png &>/dev/null
  mogrify -resize 32x -unsharp 0.5x0.5+0.5+0.008 $SCRIPT_PATH/photos/**/*.placeholder.jpg &>/dev/null
  mogrify -resize 32x -unsharp 0.5x0.5+0.5+0.008 $SCRIPT_PATH/photos/**/*.placeholder.JPEG &>/dev/null
  mogrify -resize 32x -unsharp 0.5x0.5+0.5+0.008 $SCRIPT_PATH/photos/**/*.placeholder.PNG &>/dev/null
  mogrify -resize 32x -unsharp 0.5x0.5+0.5+0.008 $SCRIPT_PATH/photos/**/*.placeholder.JPG &>/dev/null
